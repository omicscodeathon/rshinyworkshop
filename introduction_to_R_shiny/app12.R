...
ui <- fluidPage(
  ...
  sidebarLayout(
    #left side
    sidebarPanel( width = 4, height =6, 
                  style = "background-color: gray; ", # Background color 
      h1("Inputs"),

      # request data file path
      fileInput('data_file', h2('Choose file to upload')),
      # Numeric input
      ...
      actionButton("submit", label = "Submit",
                   style = "color: black; background-color: #007bff; border-color: #007bff;"), # Blue color
    ),
